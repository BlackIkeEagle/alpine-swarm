...
vagrant ssh storage-1 -- 'sudo mkdir -p /srv/storage/magento2/mysql'
...
vagrant ssh-config storage-1 > tmpsshconfig 2>/dev/null
scp -F tmpsshconfig env.php storage-1:env.php
rm tmpsshconfig
vagrant ssh storage-1 -- 'cd /srv/storage/magento2/; sudo mv /home/vagrant/env.php ./'
vagrant ssh storage-1 -- 'cd /srv/storage/magento2/; sudo chown -R 33:33 var media env.php; sudo chown -R 100:101 redis; sudo chown -R 999:999 mysql'
